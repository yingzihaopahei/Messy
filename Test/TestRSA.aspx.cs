...
namespace Test
{
    public partial class TestRSA : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            RSAKey(out xmlPrivatekey, out xmlPublickey);
            string n = RSAEncrypt(xmlPublickey,"111");
            string u = RSADecrypt(xmlPrivatekey, n); 
